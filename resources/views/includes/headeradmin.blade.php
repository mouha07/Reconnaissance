...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavId">
                    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-body" href="/sante">Phythopatologie</a>
                        </li>
                        @if (Auth::guest())
                        ...
                        <li class="nav-item dropdown text-body">
                            <a class="nav-link dropdown-toggle text-body" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">CROUD</a>
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="#">Spéculation</a>
                            <a class="dropdown-item" href="#">Sol</a>
                            <a class="dropdown-item" href="#">Apport nutritif des aliments</a>
                            <a class="dropdown-item" href="#">Phytopatologie</a>
                            <a class="dropdown-item" href="#">Engrais</a>
                            </div>
                        </li>
                    </ul>
    ...
    {{-- <script src="{{asset('angular/tsconfig.json')}}"></script> --}}
