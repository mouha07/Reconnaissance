            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavId">
                    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-body" href="/fertilisation">Données sauvegardées</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="row mt-3">
            ...
            <div class="col-12 center-block p-3">
                <div class="row justify-content-center ">
                    ...
                    <div class="col-12 m-2 text-center font-weight-bold text-success">Images enregistrées</div>

                    <div class="card" style="height:500px; width:500px">

                        <img class="" src="image/image1.jpg" alt="">
                        {{-- <img class="" src="image/image2.jpg" alt=""> --}}
